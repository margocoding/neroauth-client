...
const HelpPage = () => {
  ...
  function StepCard({ index, image, alt, title, text }) {
    ...
    const transparentPng =
      "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAIAAAACACAYAAADDPmHLAAAAFElEQVR42u3BMQEAAADCoPdPbQ43oAAAAAAAAJ8G3mQAAQzZy3QAAAAASUVORK5CYII=";
    ...
    return (
      <div className="w-full">
        ...
        {index < cards.length - 1 && (
          <div className="flex flex-col items-center mb-4" aria-hidden>
            <div className="h-4 w-0.5 bg-gradient-to-b from-transparent via-white/30 to-transparent"></div>
            <div className="w-8 h-8 rounded-full grid place-items-center bg-white/5 border border-white/10 shadow-[0_0_20px_rgba(255,150,60,0.25)]">
              <svg
        ...
        <div className="mt-12 pt-8 border-t border-white/10">
          ...
          <div className="mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-4 max-w-2xl mx-auto">
              {/* Shizuku */}
              <div className="rounded-2xl overflow-hidden neon-box glass border border-white/10 p-4 text-center">
              ...
              <div className="rounded-2xl overflow-hidden neon-box glass border border-white/10 p-4 text-center">
                ...
                <p className="text-gray-300 mb-3 text-sm">
                  {t(
                    "help.troubleshooting.tools.installwithoptions.description",
                  )}
                </p>
                <a
                  href="/downloads/InstallWithOptions.apk"
                  className="block w-full bg-orange-500 hover:bg-orange-600 text-white font-medium py-2 px-4 rounded-lg transition-colors text-center"
                  download
                >
                  {t("help.troubleshooting.download")}
